      ...
      <div class="py-4 space-y-6">
        ...
        <div class="flex items-center gap-4">
          ...
          <el-button
            ...
            class="!bg-red-600 !text-white hover:!bg-red-500 !border-none"
          >
...
import { getDockerStatus, installDocker, startDocker, stopDocker, restartDocker } from '../../api'
...
const handleRestartDocker = async () => {
  ElMessageBox.confirm('确定要重启 Docker 服务吗？此操作会导致所有运行中的容器暂时中断。', '重启 Docker', {
    ...
    operating.value = true
    ElMessage.info('正在重启 Docker 服务...')
    try {
      const res: any = await restartDocker()
      if (res.code === 200) {
